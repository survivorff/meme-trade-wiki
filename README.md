...
2024 年，Pump.fun 在 Solana 上点燃了 Meme 币狂潮。短短一年多，围绕 Meme 币交易诞生了一个完整的生态 —— 发射台、交易平台、狙击机器人、跟单工具、数据分析、MEV 套利 —— 累计创造了数十亿美元的交易量和超过十亿美元的收入。随后，这股风潮扩散到 Base、BSC、Ethereum 等多条链，形成了一个跨链的 Meme 交易世界。
...
| 🌐 **多链玩家** | 第八章 | 看清各链 Meme 生态的差异和机会 |

---

## 🔗 按链查看

知识库以 Solana 为主线（Solana 仍占 Meme 交易市场 80%+），但也覆盖其他链的 Meme 生态。

| 链 | 相关章节 |
|----|---------|
| **Solana** | 第一 ~ 第七章（全部）+ 8.1 |
| **Base** | 8.2 + 第一、七章（通用部分） |
| **BSC** | 8.3 + 2.2（Four.meme）+ 第一、七章 |
| **Ethereum** | 8.4 + 第一、七章 |
| **多链通用** | 第一章、第七章、8.5、8.6 |
...
> Meme 交易不只是 Solana 的事。看清各链的差异、机会和共性。
